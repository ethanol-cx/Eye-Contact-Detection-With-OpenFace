function [patches, pdm, clmParams, early_term_params] = Load_CECLM_of()
%LOAD_PATCH_EXPERTS Summary of this function goes here
%   Detailed explanation goes here
   
    % Load the patch experts/local detectors
    [patches] = Load_CECLM_Patch_Experts( '../models/cen/', 'cen_patches_*_of.mat');
    ...
    load('../learn_error_mapping/cen_menpo_mapping_of.mat');    
end
