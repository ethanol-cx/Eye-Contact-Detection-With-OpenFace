 function Script_DCLM_general_vis_select_base()
...
% Base is 0.033 mean and 0.0291 median
...
%         patches(2).visibilities(to_rem_from,:) = 1;
    ...
    output_results = 'results/results_wild_dclm_vis_on.mat';
